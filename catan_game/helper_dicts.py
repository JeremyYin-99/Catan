...
resources = ("wool", "lumber", "grain", "ore", "brick")
...
Trade with Port: 5
Use Knight: 19
Use Road Building: 1 # piggyback off of a regular road and allow two actions with mask
Use Year of Plenty: 25 # two turns where resource is chosen
Use Monopoly: 5
End Turn: 1
Discard: 5 # Choose resource to discard until half
Sum: 247
...
BOARD STUFF
-----------
NODE SETTLEMENT VALUE: 54 ### Combine with cities using an integer representation (0 unoccupoed, 1 settlement, 2 city)
NODE OWNER: 54 (0 unowned otherwise owner int)
EDGE ROADS: 72 (0 unowned otherwise owner int)
PORT RESOURCE: 9 (int)
TILE RESOURCE: 19 (int)
TILE VALUE: 19 (int)
TILE ROBBER: 1 (int tile number)
