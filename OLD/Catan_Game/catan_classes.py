...
class Player:
    ...
    def calculate_total_cards(self):
        self.total_cards = self.resource["wool"] + self.resource["lumber"] + self.resource["grain"] + self.resource["ore"] + self.resource["brick"]
...
class Actions:
    def __init__(self, player:Player, board:Board, game:Game) -> None:
        self.player = player
        self.board = board
        self.game = game
